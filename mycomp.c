...
int is_running = OK;      // a global variable that changes only when closing the program
...
struct
{
    ...
    {"print_comp", print_comp}, {"abs_comp", abs_comp}, {"mult_comp_real", mult_comp_real}, {"mult_comp_img", mult_comp_img}, {"read_comp", read_comp}, {"add_comp", add_comp}, {"sub_comp", sub_comp}, {"mult_comp_comp", mult_comp_comp}, {"stop", stop}, {"not_valid", NULL}};
